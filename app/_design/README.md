...
Claude Design has four input channels. Recommended usage:

| Slot                           | What to put there                                                                   |
| ------------------------------ | ----------------------------------------------------------------------------------- |
| **Frontend-focused subfolder** | Attach `app/_design/` via GitHub. This is the foundation.                           |
| **Fonts**                      | Attach the six `.woff2` files from `assets/fonts/`. Forces exact font use.          |
| **Logos & assets**             | Attach the four screenshots from `assets/inspiration/`. Multimodal taste reference. |
| **Notes textarea**             | Paste the short version from `NOTES-FOR-CLAUDE-DESIGN.md`. Gestalt context.         |
| **`.fig` slot**                | Leave empty. See `assets/figma-leads.md` for why.                                   |
