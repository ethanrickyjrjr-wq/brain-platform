...
Then close with the report link (a clickable URL; it may contain an internal slug — link it, never speak the slug), and last of all the as-of date (MM/DD/YYYY) stated once; never the raw token.
