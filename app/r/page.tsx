        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {EXAMPLES.map((e) => (
            <Link
              ...
              className="rounded-full border border-white/10 bg-white/[0.04] px-3.5 py-1.5 text-sm text-gray-200 transition-colors hover:border-[#00d4aa]/50 hover:text-white"
            >
              {e.label}
            </Link>
          ))}
