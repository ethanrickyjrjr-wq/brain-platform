...
const change = {
  slug: "mortgage_rate", item_id: "i1", label: "30-yr rate",
  previous_value: "6.8%", current_value: "7.3%",
  delta_description: "rose 7.4%", signal_strength: 2, impact_weight: 8, priority: 16,
};

test("states both numbers, never asserts the user is wrong", () => {
  const t = collisionChipText(change as any);
