...
**Task:** Write the `dlt` sources/resources in the `refinery/` directory to pull these endpoints into raw Supabase tables. Ensure they are tagged correctly for the Semantic Ledger.
...
**Task:** Design the DAG edge-typing schema to support these dynamic "Synthesis" relationships between Atomic Brains.
...
## 📝 Execution Rules
*   Operate strictly within `brain-platform`.
