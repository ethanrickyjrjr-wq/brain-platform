...
| `rental_rent_index_zori` | Zillow Observed Rent Index (ZORI) — ZIP-Level Monthly Rent | `rental_rent_index_zori` | index | USD/month | 500 – 15000 | `rentals-swfl`, `master` | `real-estate` | ✅ active |
| `rental_rent_index_zori_regional_median` | ZORI Rent Index — SWFL Regional Median | `rental_rent_index_zori_regional_median` | index | USD/month | 500 – 10000 | `rentals-swfl`, `master` | `real-estate` | ✅ active |
| `rental_rent_mom_pct` | ZORI Rent MoM % — ZIP Level | `rental_rent_mom_pct` | percent_change | % | -20 – 20 | `rentals-swfl` | `real-estate` | ✅ active |
| `rental_rent_yoy_pct` | ZORI Rent YoY % — ZIP Level | `rental_rent_yoy_pct` | percent_change | % | -50 – 50 | `rentals-swfl`, `master` | `real-estate` | ✅ active |
| `rental_rent_yoy_pct_regional_median` | ZORI Rent YoY % — SWFL Regional Median | `rental_rent_yoy_pct_regional_median` | percent_change | % | -50 – 50 | `rentals-swfl`, `master` | `real-estate` | ✅ active |
...
- **`rental_rent_yoy_pct_regional_median`** — Median YoY % across SWFL ZIPs — the headline signal that drives rentals-swfl direction polarity per the locked band table (bearish < 0; neutral [0,2); bullish [2,6]; bullish with caveat (6,10]; neutral with caveat > 10).
- **`rental_rent_yoy_pct_top_heating_zips`** — Comma-joined list of the top-N (default 3) SWFL ZIPs by rental_rent_yoy_pct at the latest period_end. Categorical metric — value is a label string, not a number.
- **`rentals_swfl_zips_covered`** — Count of distinct SWFL ZIPs present in the rentals-swfl corpus for the current build. Sentinel for corpus thinness — a low count fires a 'regional median is thin' caveat.
...
| `rental_rent_index_zori` | Zillow Observed Rent Index (ZORI) — ZIP-Level Monthly Rent | `rental_rent_index_zori` | active |
| `rental_rent_index_zori_regional_median` | ZORI Rent Index — SWFL Regional Median | `rental_rent_index_zori_regional_median` | active |
| `rental_rent_yoy_pct` | ZORI Rent YoY % — ZIP Level | `rental_rent_yoy_pct` | active |
| `rental_rent_yoy_pct_regional_median` | ZORI Rent YoY % — SWFL Regional Median | `rental_rent_yoy_pct_regional_median` | active |
...
| `rental_rent_index_zori` | Zillow Observed Rent Index (ZORI) — ZIP-Level Monthly Rent | `rental_rent_index_zori` | active |
| `rental_rent_index_zori_regional_median` | ZORI Rent Index — SWFL Regional Median | `rental_rent_index_zori_regional_median` | active |
| `rental_rent_mom_pct` | ZORI Rent MoM % — ZIP Level | `rental_rent_mom_pct` | active |
| `rental_rent_yoy_pct` | ZORI Rent YoY % — ZIP Level | `rental_rent_yoy_pct` | active |
| `rental_rent_yoy_pct_regional_median` | ZORI Rent YoY % — SWFL Regional Median | `rental_rent_yoy_pct_regional_median` | active |
