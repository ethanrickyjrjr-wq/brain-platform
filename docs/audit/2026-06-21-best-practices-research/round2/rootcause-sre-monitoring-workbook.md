...
[![Google](https://lh3.googleusercontent.com/YoVRtLOHMSRYQZ3OhFL8RIamcjFYbmQXX4oAQx02MRqqY9zlKNvsuZpS73khXiOqTH3qrFW27VrERJJIHTjPk-tAh46q8-Fd4w6qlw)](https://www.google.com)
  1. [Table of Contents](https://sre.google/workbook/table-of-contents/)
  2. [ Foreword I ](https://sre.google/workbook/foreword-I/)
  3. [ Foreword II ](https://sre.google/workbook/foreword-II/)
  4. [ Preface ](https://sre.google/workbook/preface/)
  5. [ 1. How SRE Relates to DevOps ](https://sre.google/workbook/how-sre-relates/)
  6. [ Part I - Foundations ](https://sre.google/workbook/part-I-foundations/)
  7. [ 2. Implementing SLOs ](https://sre.google/workbook/implementing-slos/)
  8. [ 3. SLO Engineering Case Studies ](https://sre.google/workbook/slo-engineering-case-studies/)
  9. [ 4. Monitoring ](https://sre.google/workbook/monitoring/)
  10. [ 5. Alerting on SLOs ](https://sre.google/workbook/alerting-on-slos/)
  11. [ 6. Eliminating Toil ](https://sre.google/workbook/eliminating-toil/)
  12. [ 7. Simplicity ](https://sre.google/workbook/simplicity/)
  13. [ Part II - Practices ](https://sre.google/workbook/part-II-practices/)
  14. [ 8. On-Call ](https://sre.google/workbook/on-call/)
  15. [ 9. Incident Response ](https://sre.google/workbook/incident-response/)
  16. [ 10. Postmortem Culture: Learning from Failure ](https://sre.google/workbook/postmortem-culture/)
  17. [ 11. Managing Load ](https://sre.google/workbook/managing-load/)
  18. [ 12. Introducing Non-Abstract Large System Design ](https://sre.google/workbook/non-abstract-design/)
  19. [ 13. Data Processing Pipelines ](https://sre.google/workbook/data-processing/)
  20. [ 14. Configuration Design and Best Practices ](https://sre.google/workbook/configuration-design/)
  21. [ 15. Configuration Specifics ](https://sre.google/workbook/configuration-specifics/)
  22. [ 16. Canarying Releases ](https://sre.google/workbook/canarying-releases/)
  23. [ Part III - Processes ](https://sre.google/workbook/part-III-processes/)
  24. [ 17. Identifying and Recovering from Overload ](https://sre.google/workbook/overload/)
  25. [ 18. SRE Engagement Model ](https://sre.google/workbook/engagement-model/)
  26. [ 19. SRE: Reaching Beyond Your Walls ](https://sre.google/workbook/reaching-beyond/)
  27. [ 20. SRE Team Lifecycles ](https://sre.google/workbook/team-lifecycles/)
  28. [ 21. Organizational Change Management in SRE ](https://sre.google/workbook/organizational-change/)
  29. [ Conclusion ](https://sre.google/workbook/conclusion/)
  30. [ Appendix A. Example SLO Document ](https://sre.google/workbook/slo-document/)
  31. [ Appendix B. Example Error Budget Policy ](https://sre.google/workbook/error-budget-policy/)
  32. [ Appendix C. Results of Postmortem Analysis ](https://sre.google/workbook/postmortem-analysis/)
  33. [ Index ](https://sre.google/workbook/index/)
  34. [ About the Editors ](https://sre.google/workbook/editors/)
  35. [ Colophon ](https://sre.google/workbook/colophon/)
...
Precision
  * The proportion of events detected that were significant. Precision is 100% if every alert corresponds to a significant event. Note that alerting can become particularly sensitive to nonsignificant events during low-traffic periods (discussed in [Low-Traffic Services and Error Budget Alerting](https://sre.google/workbook/alerting-on-slos/#low-traffic-services-and-error-budget-alerting)).
...
For the purposes of this discussion, “error budgets” and “error rates” apply to all SLIs, not just those with “error” in their name. In the section [What to Measure: Using SLIs](https://sre.google/workbook/implementing-slos#what-to-measure-using-slis), we recommend using SLIs that capture the ratio of good events to total events. The error budget gives the number of allowed bad events, and the error rate is the ratio of bad events to total events. 
...
[Figure 5-1](https://sre.google/workbook/alerting-on-slos/#detection-time) shows the relationship between detection time and error rate for an example service with an alert window of 10 minutes and a 99.9% SLO. 
![detection-time](https://lh3.googleusercontent.com/mpK6cdpAGND9oCGaTETVhOmXF5TZegWCspB5h4p2JJmWmAgOgdEE8LVMSod2YSU5JGlMs0Ok7rKz7LvRwi48QrMRf0WTByDB4ynP=s1325) Figure 5-1. Detection time for an example service with an alert window of 10 minutes and a 99.9% SLO
[Table 5-1](https://sre.google/workbook/alerting-on-slos/#immediate-error-rate-is-too-high) shows the benefits and disadvantages of alerting when the immediate error rate is too high.   
...
[Table 5-2](https://sre.google/workbook/alerting-on-slos/#error-rate-is-too-high-over-a-larger-window) shows the benefits and disadvantages of alerting when the error rate is too high over a larger window of time.   
...
[Figure 5-2](https://sre.google/workbook/alerting-on-slos/#error-rate-over-a-36-hour-period) shows that while the error rate over a 36-hour period has fallen to a negligible level, the 36-hour average error rate remains above the threshold. 
![error-rate-over-a-36-hour-period](https://lh3.googleusercontent.com/l5RR_VJmzwXDJfT-zuOj2YvfnRnSoOhGUzDvpQOE9Txq1fH3BUhJ1qHsw-dQBWOtoeIk6eTRu3QPyPFs9qOWVWCncFGu8ZwhxUvh=s1404) Figure 5-2. Error rate over a 36-hour period
...
[Table 5-3](https://sre.google/workbook/alerting-on-slos/#benefits-and-disadvantages-of-using-a-duration) shows the benefits and disadvantages of using a duration parameter for alerts.   
Table 5-3.Pros and cons of using a duration parameter for alerts  
| Pros  | Cons  |  
| --- | --- |  
| Alerts can be higher precision. Requiring a sustained error rate before firing means that alerts are more likely to correspond to a significant event.  |  Poor recall and poor detection time: Because the duration does not scale with the severity of the incident, a [100% outage alerts](https://sre.google/workbook/error-budget-policy/) after one hour, the same detection time as a 0.2% outage. The 100% outage would consume 140% of the 30-day budget in that hour. If the metric even momentarily returns to a level within SLO, the duration timer resets. An SLI that fluctuates between missing SLO and passing SLO may never alert.  |  
For the reasons listed in [Table 5-3](https://sre.google/workbook/alerting-on-slos/#benefits-and-disadvantages-of-using-a-duration), we do not recommend using durations as part of your SLO-based alerting criteria.[1](https://sre.google/workbook/alerting-on-slos/#ch05fn1)
[Figure 5-3](https://sre.google/workbook/alerting-on-slos/#service_with_100percent_error_spikes_ever) shows the average error rate over a 5-minute window of a service with a 10-minute duration before the alert fires. A series of 100% error spikes lasting 5 minutes every 10 minutes never triggers an alert, despite consuming 35% of the error budget. 
![service_with_100percent_error_spikes_ever](https://lh3.googleusercontent.com/v1je8P1Sp24yIu1v3EJuy2aH47hCpZksaQ7q2zbK9yWEY8cKeExMYi0jSdvqxlUAIGzDfiQm0-EDUqDOpiIt8iknFKJgRFzvE-NhDg=s1461) Figure 5-3. A service with 100% error spikes every 10 minutes
...
Burn rate is how fast, relative to the SLO, the service consumes the error budget. [Figure 5-4](https://sre.google/workbook/alerting-on-slos/#error_budgets_relative_to_burn_rates) shows the relationship between burn rates and error budgets. 
...
![error_budgets_relative_to_burn_rates](https://lh3.googleusercontent.com/XG34GssRWHMFGz0S5QjVsihHR444ZARuk9ynjq6fFCOmWwPrs7boARO7QncJ33JhTte9j6qGkj8Xag8Cz7i89kjxTLZZQ6q9ydOPRA=s1372) Figure 5-4. Error budgets relative to burn rates
[Table 5-4](https://sre.google/workbook/alerting-on-slos/#burn_rates_and_time_to_complete_budget_ex) shows burn rates, their corresponding error rates, and the time it takes to exhaust the SLO budget.   
...
[Table 5-5](https://sre.google/workbook/alerting-on-slos/#pros_and_cons_of_alerting_based_on_burn_r) shows the benefits and limitations of alerting based on burn rate.   
...
[Table 5-6](https://sre.google/workbook/alerting-on-slos/#recommended_time_windows_and_burn_rates_f) shows the corresponding burn rates and time windows for percentages of SLO budget consumed.   
...
[Figure 5-5](https://sre.google/workbook/alerting-on-slos/#recommended_time_windows_and_burn_rates_f) shows the detection time and alert type according to the error rate. 
![recommended_time_windows_and_burn_rates_f](https://lh3.googleusercontent.com/SLw760xP6lIoejFO8BA7L3QhNg6IohTR0a8qzX8NnrUyxqtReRPOrLm5NEPK1VhU14tMUK5chuKvPGDAdnGwnwsw4fjUGH1AwAm5ew=s1378) Figure 5-5. Error rate, detection time, and alert notification
Multiple burn rates allow you to adjust the alert to give appropriate priority based on how quickly you have to respond. If an issue will exhaust the error budget within hours or a few days, sending an active notification is appropriate. Otherwise, a ticket-based notification to address the alert the next working day is more appropriate.[2](https://sre.google/workbook/alerting-on-slos/#ch05fn2)
[Table 5-7](https://sre.google/workbook/alerting-on-slos/#pros_and_cons_of_using_multiple_burn_rate) lists the benefits and disadvantages of using multiple burn rates.   
...
A good guideline is to make the short window 1/12 the duration of the long window, as shown in [Figure 5-6](https://sre.google/workbook/alerting-on-slos/#short_and_long_windows_for_alerting). The graph shows both alerting threshold. After experiencing 15% errors for 10 minutes, the short window average goes over the alerting threshold immediately, and the long window average goes over the threshold after 5 minutes, at which point the alert starts firing. The short window average drops below the threshold 5 minutes after the errors stop, at which point the alert stops firing. The long window average drops below the threshold 60 minutes after the errors stop. 
![short_and_long_windows_for_alerting](https://lh3.googleusercontent.com/zXV7tBjExfvf6CKjs_v4orEQFED7kEJHq7bS6TcOhogGFcjDNTrlUhyp2L0fOE8IuASrBQ9yvE6-vs6Rc8Upzr15RGfYKwcIvcAnkw=s1410) Figure 5-6. Short and long windows for alerting
...
We recommend the parameters listed in [Table 5-8](https://sre.google/workbook/alerting-on-slos/#recommended_parameters_for_an_slo_based_a) as the starting point for your SLO-based alerting configuration.   
...
The best solution depends on the nature of the service: what is the impact[3](https://sre.google/workbook/alerting-on-slos/#ch05fn3) of a single failed request? A high-availability target may be appropriate if failed requests are one-off, high-value requests that aren’t retried. It may make sense from a business perspective to investigate every single failed request. However, in this case, the alerting system notifies you of an error too late. 
...
Alerting on significant events aims to provide sufficient notice to mitigate problems before they exhaust the entire error budget. If you can’t adjust the monitoring to be less sensitive to ephemeral events, and generating synthetic traffic is impractical, you might instead consider changing the service to reduce the user impact of a single failed request. For example, you might: 
  * Modify the client to retry, with exponential backoff and jitter.[4](https://sre.google/workbook/alerting-on-slos/#ch05fn4)
...
In this case, we strongly advise against specifying the alert window and burn rate parameters independently for each service, because doing so quickly becomes overwhelming.[5](https://sre.google/workbook/alerting-on-slos/#ch05fn5) Once you decide on your alerting parameters, apply them to all your services. 
...
By grouping requests rather than placing unique availability and latency objectives on all request types, you can group requests into five buckets, like the example in [Table 5-10](https://sre.google/workbook/alerting-on-slos/#request_class_buckets_according_to_simila).  
Table 5-10.Request class buckets according to similar availability requirements and thresholds  
| Request class  | Availability  | Latency @ 90%[6](https://sre.google/workbook/alerting-on-slos/#ch05fn6)  | Latency @ 99%  |  
| --- | --- | --- | --- |  
...
[1](https://sre.google/workbook/alerting-on-slos/#ch05fn1-marker)Duration clauses can occasionally be useful when you are filtering out ephemeral noise over very short durations. However, you still need to be aware of the cons listed in this section. 
[2](https://sre.google/workbook/alerting-on-slos/#ch05fn2-marker)As described in the [introduction](https://sre.google/sre-book/introduction/) to Site Reliability Engineering, pages and tickets are the only valid ways to get a human to take action. 
[3](https://sre.google/workbook/alerting-on-slos/#ch05fn3-marker)The section [What to Measure: Using SLIs](https://sre.google/workbook/implementing-slos#what-to-measure-using-slis) recommends a style of SLI that scales according to the impact on the user. 
[4](https://sre.google/workbook/alerting-on-slos/#ch05fn4-marker)See [“Overloads and Failure”](https://sre.google/sre-book/service-best-practices#id-AnCKIZFpUej) in Site Reliability Engineering. 
[5](https://sre.google/workbook/alerting-on-slos/#ch05fn5-marker)With the exception of temporary changes to alerting parameters, which are necessary when you’re fixing an ongoing outage and you don’t need to receive notifications during that period. 
[6](https://sre.google/workbook/alerting-on-slos/#ch05fn6-marker)Ninety percent of requests are [faster than this threshold](https://sre.google/sre-book/service-level-objectives#id-9nCjSvF4t4iN). 
[ Previous Chapter 4 - Monitoring  ](https://sre.google/workbook/monitoring/)
[ Next Chapter 6 - Eliminating Toil  ](https://sre.google/workbook/eliminating-toil/)
Copyright © 2018 Google, Inc. Published by O'Reilly Media, Inc. Licensed under [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/)
