[Crawl4AI Documentation (v0.9.x)](https://docs.crawl4ai.com/)
  ...
  * [ Search ](https://docs.crawl4ai.com/core/table_extraction/)


[ unclecode/crawl4ai 69.1k 7.1k ](https://github.com/unclecode/crawl4ai)
×
  * [Home](https://docs.crawl4ai.com/)
  * [Growth](https://docs.crawl4ai.com/stats/)
  * [Ask AI](https://docs.crawl4ai.com/core/ask-ai/)
  ...
  * Core
    ...
    * [Domain Mapping](https://docs.crawl4ai.com/core/domain-mapping/)
  ...
  * Legal
    * [Privacy Policy](https://docs.crawl4ai.com/privacy/)
    * [Terms of Service](https://docs.crawl4ai.com/terms/)
    * [Support](https://docs.crawl4ai.com/support/)


* * *
  * [Table Extraction Strategies](https://docs.crawl4ai.com/core/table_extraction/#table-extraction-strategies)
  * [Overview](https://docs.crawl4ai.com/core/table_extraction/#overview)
  * [Quick Start](https://docs.crawl4ai.com/core/table_extraction/#quick-start)
  * [Table Extraction Strategies](https://docs.crawl4ai.com/core/table_extraction/#table-extraction-strategies_1)
  * [Extracted Table Structure](https://docs.crawl4ai.com/core/table_extraction/#extracted-table-structure)
  * [Configuration Options](https://docs.crawl4ai.com/core/table_extraction/#configuration-options)
  * [Working with Extracted Tables](https://docs.crawl4ai.com/core/table_extraction/#working-with-extracted-tables)
  * [Creating Custom Strategies](https://docs.crawl4ai.com/core/table_extraction/#creating-custom-strategies)
  * [Combining with Other Strategies](https://docs.crawl4ai.com/core/table_extraction/#combining-with-other-strategies)
  * [Performance Considerations](https://docs.crawl4ai.com/core/table_extraction/#performance-considerations)
  * [Migration Guide](https://docs.crawl4ai.com/core/table_extraction/#migration-guide)
  * [Best Practices](https://docs.crawl4ai.com/core/table_extraction/#best-practices)
  * [Troubleshooting](https://docs.crawl4ai.com/core/table_extraction/#troubleshooting)
  * [See Also](https://docs.crawl4ai.com/core/table_extraction/#see-also)
...
> **🚧 WORK IN PROGRESS** : We are actively developing an **advanced non-LLM algorithm** that will handle complex table structures (rowspan, colspan, nested tables) for **FREE**. This will replace the need for costly LLM extraction in most cases. Coming soon!
...
✅ **Use ONLY when** : - Tables have complex merged cells (rowspan/colspan) that break DefaultTableExtraction - Nested tables that need semantic understanding - Tables with irregular structures - You've tried DefaultTableExtraction and it failed
❌ **Never use when** : - DefaultTableExtraction works (99% of cases) - Tables are simple or well-structured - You're processing many pages (costs add up!) - Tables have 100+ rows (very slow)
...
**Chunking Parameters** : - `enable_chunking` (default: `True`): Automatically handle large tables - `chunk_token_threshold` (default: `3000`): When to split tables - `min_rows_per_chunk` (default: `10`): Ensures meaningful chunk sizes - `max_parallel_chunks` (default: `5`): Concurrent processing for speed
...
**Strategy Selection Guide** : - **DefaultTableExtraction** : Use for 99% of cases - it's free and effective - **LLMTableExtraction** : Only for complex tables with merged cells that break DefaultTableExtraction - **NoTableExtraction** : When you only need text/markdown content - **Custom Strategy** : For specialized requirements (financial, scientific, etc.)
...
## See Also
  * [Extraction Strategies](https://docs.crawl4ai.com/core/table_extraction/extraction-strategies.md) - Overview of all extraction strategies
  * [Content Selection](https://docs.crawl4ai.com/core/content-selection/) - Using CSS selectors and filters
  * [Performance Optimization](https://docs.crawl4ai.com/core/optimization/performance-tuning.md) - Speed up extraction
  * [Examples](https://docs.crawl4ai.com/core/examples/table_extraction_example.py) - Complete working examples


Page Copy
Page Copy
  * [ Copy as Markdown Copy page for LLMs ](https://docs.crawl4ai.com/core/table_extraction/)
  * [ View as Markdown Open raw source ](https://docs.crawl4ai.com/core/table_extraction/)
  * [ Open in ChatGPT Ask questions about this page ](https://docs.crawl4ai.com/core/table_extraction/)


ESC to close
#### On this page
  * [Overview](https://docs.crawl4ai.com/core/table_extraction/#overview)
  * [What's Changed?](https://docs.crawl4ai.com/core/table_extraction/#whats-changed)
  * [Key Points](https://docs.crawl4ai.com/core/table_extraction/#key-points)
  * [Quick Start](https://docs.crawl4ai.com/core/table_extraction/#quick-start)
  * [The Simplest Way (Works Like Before)](https://docs.crawl4ai.com/core/table_extraction/#the-simplest-way-works-like-before)
  * [Using the Old Configuration (Still Supported)](https://docs.crawl4ai.com/core/table_extraction/#using-the-old-configuration-still-supported)
  * [Table Extraction Strategies](https://docs.crawl4ai.com/core/table_extraction/#table-extraction-strategies_1)
  * [Understanding the Strategy Pattern](https://docs.crawl4ai.com/core/table_extraction/#understanding-the-strategy-pattern)
  * [Available Strategies](https://docs.crawl4ai.com/core/table_extraction/#available-strategies)
  * [DefaultTableExtraction](https://docs.crawl4ai.com/core/table_extraction/#defaulttableextraction)
  * [Scoring System](https://docs.crawl4ai.com/core/table_extraction/#scoring-system)
  * [LLMTableExtraction (Use Sparingly!)](https://docs.crawl4ai.com/core/table_extraction/#llmtableextraction-use-sparingly)
  * [When to Use LLMTableExtraction](https://docs.crawl4ai.com/core/table_extraction/#when-to-use-llmtableextraction)
  * [How Smart Chunking Works](https://docs.crawl4ai.com/core/table_extraction/#how-smart-chunking-works)
  * [Performance Optimization for LLMTableExtraction](https://docs.crawl4ai.com/core/table_extraction/#performance-optimization-for-llmtableextraction)
  * [NoTableExtraction](https://docs.crawl4ai.com/core/table_extraction/#notableextraction)
  * [Extracted Table Structure](https://docs.crawl4ai.com/core/table_extraction/#extracted-table-structure)
  * [Configuration Options](https://docs.crawl4ai.com/core/table_extraction/#configuration-options)
  * [Basic Configuration](https://docs.crawl4ai.com/core/table_extraction/#basic-configuration)
  * [Advanced Configuration](https://docs.crawl4ai.com/core/table_extraction/#advanced-configuration)
  * [Working with Extracted Tables](https://docs.crawl4ai.com/core/table_extraction/#working-with-extracted-tables)
  * [Convert to Pandas DataFrame](https://docs.crawl4ai.com/core/table_extraction/#convert-to-pandas-dataframe)
  * [Filter Tables by Criteria](https://docs.crawl4ai.com/core/table_extraction/#filter-tables-by-criteria)
  * [Export Tables to Different Formats](https://docs.crawl4ai.com/core/table_extraction/#export-tables-to-different-formats)
  * [Creating Custom Strategies](https://docs.crawl4ai.com/core/table_extraction/#creating-custom-strategies)
  * [Example: Financial Table Extractor](https://docs.crawl4ai.com/core/table_extraction/#example-financial-table-extractor)
  * [Example: Specific Table Extractor](https://docs.crawl4ai.com/core/table_extraction/#example-specific-table-extractor)
  * [Combining with Other Strategies](https://docs.crawl4ai.com/core/table_extraction/#combining-with-other-strategies)
  * [Performance Considerations](https://docs.crawl4ai.com/core/table_extraction/#performance-considerations)
  * [Optimization Tips](https://docs.crawl4ai.com/core/table_extraction/#optimization-tips)
  * [Migration Guide](https://docs.crawl4ai.com/core/table_extraction/#migration-guide)
  * [Important: Your Code Still Works!](https://docs.crawl4ai.com/core/table_extraction/#important-your-code-still-works)
  * [How It Works Internally](https://docs.crawl4ai.com/core/table_extraction/#how-it-works-internally)
  * [v0.7.2 and Earlier](https://docs.crawl4ai.com/core/table_extraction/#v072-and-earlier)
  * [v0.7.3+ (Current)](https://docs.crawl4ai.com/core/table_extraction/#v073-current)
  * [Taking Advantage of New Features](https://docs.crawl4ai.com/core/table_extraction/#taking-advantage-of-new-features)
  * [Summary](https://docs.crawl4ai.com/core/table_extraction/#summary)
  * [Best Practices](https://docs.crawl4ai.com/core/table_extraction/#best-practices)
  * [1. Choose the Right Strategy (Cost-Conscious Approach)](https://docs.crawl4ai.com/core/table_extraction/#1-choose-the-right-strategy-cost-conscious-approach)
  * [2. Validate Extracted Data](https://docs.crawl4ai.com/core/table_extraction/#2-validate-extracted-data)
  * [3. Handle Edge Cases](https://docs.crawl4ai.com/core/table_extraction/#3-handle-edge-cases)
  * [Troubleshooting](https://docs.crawl4ai.com/core/table_extraction/#troubleshooting)
  * [Common Issues and Solutions](https://docs.crawl4ai.com/core/table_extraction/#common-issues-and-solutions)
  * [Debug Logging](https://docs.crawl4ai.com/core/table_extraction/#debug-logging)
  * [See Also](https://docs.crawl4ai.com/core/table_extraction/#see-also)
