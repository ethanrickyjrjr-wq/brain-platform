...
| **`proxy_config`** |  `ProxyConfig`, `list[ProxyConfig]`, or `None` (None)  | Proxy configuration for this specific crawl. Pass a single proxy or an ordered list of proxies to try. See [Anti-Bot & Fallback](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/).  |  
...
| **`fallback_fetch_function`** |  `async (str) -> str or None` (None)  | Async function called as last resort after all retries are exhausted. Takes URL, returns raw HTML. See [Anti-Bot & Fallback](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/).  |  
* * *
### C) **Caching & Session**  
| **Parameter**  | **Type / Default**  | **What It Does**  |  
| --- | --- | --- |  
...
#### On this page
  ...
  * [2.2 Helper Methods](https://docs.crawl4ai.com/api/parameters/#22-helper-methods)
  * [Class-Level Defaults (set_defaults / get_defaults / reset_defaults)](https://docs.crawl4ai.com/api/parameters/#class-level-defaults-set_defaults-get_defaults-reset_defaults)
  * [2.3 Example Usage](https://docs.crawl4ai.com/api/parameters/#23-example-usage)
  * [2.4 Compliance & Ethics](https://docs.crawl4ai.com/api/parameters/#24-compliance-ethics)
  * [3.1 Parameters](https://docs.crawl4ai.com/api/parameters/#31-parameters)
  * [3.2 Example Usage](https://docs.crawl4ai.com/api/parameters/#32-example-usage)
